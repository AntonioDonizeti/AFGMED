...
from projetoafgmed.models import Usuario, Medico, Produto, FormProduto
from projetoafgmed.forms import FormCriarConta, FormLogin, FormMedico
...
def criar_conta():
    ...
    if form.validate_on_submit():
        ...
        usuario = Usuario(nome=form.nome.data, sobrenome=form.sobrenome.data,
                          email=form.email.data, senha=senha_hash)
...
# Rota para cadastrar médico (somente admin)
...
def cadastro_medico():
    ...
    if form.validate_on_submit():
        if form.foto.data:
            # Salva a foto na pasta fotos_medicos
        ...
        medico = Medico(
            ...
            foto=nome_arquivo  # Salva o nome do arquivo no banco
        )
...
# Rota para cadastrar produto (somente admin)
...
def cadastro_produto():
    ...
    if form.validate_on_submit():
        ...
        if form.foto.data:
            ...
            caminho = os.path.join(current_app.root_path, 'static/uploads', nome_foto)
            arquivo.save(caminho)
